...
def main(argv):
  ...
  data = load_data("/home/student-01-045596af54ee/car_sales.json")
  summary = process_data(data)
  new_summary = ''.join(summary)
  print(summary)
  # TODO: turn this into a PDF report
#turn summary to a paragraph and add it to the PDF
  report('/tmp/cars.pdf', "Cars report", new_summary, cars_dict_to_table(data))
  # send the PDF report as an email attachment
  msg = email_generate("automation@example.com", "student-01-045596af54ee@example.com", "Sales summary for last month", new_summary, "/tmp/cars.pdf")
  email_send(msg)
